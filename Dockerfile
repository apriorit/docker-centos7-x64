...
RUN yum install -y git subversion wget vim-common boost-devel libicu-devel zlib-devel openssl-devel libuuid-devel unixODBC-devel cryptopp-devel redhat-lsb-core
